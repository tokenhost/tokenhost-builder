...
contract FilComments_contract {
	...
	function getall() public view returns (address, uint, address, string memory, string memory, address) {
...
contract App {
	...
	function get_FilComments_N(uint256 index) public view returns (address, uint, address, string memory, string memory, address) {
	...
	function get_FilComments_user_N(address user, uint256 index) public view returns (address, uint, address, string memory, string memory, address) {
